...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>ITicketingKenya - Total Booking</title>
...
//join tblserviceprovider on tblserviceprovider.ID=tblbooking.ServiceID join tbluser on tbluser.ID=tblbooking.UserID where tblbooking.Status is null";


$sql = 'SELECT tblservice.ServiceName, tblbooking.*
FROM tblbooking
JOIN tblservice ON tblbooking.ServiceId = tblservice.ID;
';
$sql = 'SELECT tblservice.ServiceName, tblbooking.*, tblbooking.numberoftickets  
FROM tblbooking
JOIN tblservice ON tblbooking.ServiceId = tblservice.ID;';
